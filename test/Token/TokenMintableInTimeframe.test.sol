...
contract TokenMintableInTimeframeTest is Test {
    ...
    function setUp() public {
        ...
        token = new Token("Token", "TKN", 18, INITIAL_SUPPLY, 55_000_000, 365 days, 10, 0);
    ...
    function testRandomRangeYearOne() public view {
        ...
        (uint256 start, uint256 end) =
            time1 < time2 ? (creationTime + time1, creationTime + time2) : (creationTime + time2, creationTime + time1);
